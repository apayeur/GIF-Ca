...
class iGIF_Ca_NP(iGIF_Ca) :
    ...
    def simulate(self, I, V0):
        ...
        vars = [ 'theta_trace', 'theta', 'R', 'p_theta_tau', 'p_theta_bins', 'p_theta_i', 'p_T','p_dt','p_gl','p_C','p_El','p_Vr','p_Tref','p_Vt_star','p_DV','p_lambda0','V','I','p_eta','p_eta_l', 'p_gCa',
                'p_ECa', 'p_shift', 'eta_sum','p_gamma','gamma_sum','p_gamma_l','spks' ]
    ...
    def fit(self, experiment, DT_beforeSpike = 5.0, is_E_Ca_fixed=False, theta_inf_nbbins=5, theta_tau_all=np.linspace(1.0, 10.0, 5), last_bin_constrained=False, do_plot=False):

        """
        Fit the iGIF_NP_Ca model on experimental data.
    ...
    def printParameters(self):
        ...
        print "\n-------------------------"
        print "iGIF_NP_Ca model parameters:"
        print "-------------------------"
    ...
    def plotParameters(self) :
        ...
        super(iGIF_Ca_NP, self).plotParameters()
