...
class iGIF_NP(iGIF) :
    ...
    def simulateResponseToExcitatoryConductance(self, gAMPA, gNMDA, baseline_current, V0):
        ...
        vars = [ 'theta_trace', 'theta', 'R', 'p_theta_tau', 'p_theta_bins', 'p_theta_i', 'p_T','p_dt','p_gl','p_C','p_El','p_Vr','p_Tref','p_Vt_star','p_DV','p_lambda0','V','gAMPA', 'gNMDA', 'baseline_current','p_eta','p_eta_l','eta_sum','p_gamma','gamma_sum','p_gamma_l','spks' ]
